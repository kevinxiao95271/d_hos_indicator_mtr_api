-- 4.27.1.2 异位妊娠手术指征符合率（异位妊娠，手术治疗）
-- 分母 4.27.1.2.2 与 4.27.1.1.2 统计口径一致，采集源于该指标（须先执行 4.27.1.1）
...
SET @num_name = '符合异位妊娠手术指征患者数_4.27.1.2';
CALL sp_kpi_item_create(@num_name, @cat_id, NULL, 'integer', 0, 'increase', 'value', NULL, @ds_id, @param,
    '符合异位妊娠手术指征的患者数', '无', '反映异位妊娠诊疗规范性', '第四章-异位妊娠（手术治疗）质量控制查询', NULL, 'full', NULL, NULL, '分子：符合异位妊娠手术指征患者数。分母：异位妊娠手术患者总例数。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', '符合异位妊娠手术指征的患者数', NULL, NULL, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @user, CONCAT('[{"category_id":', @cat_id, ',"category_code":"4.27.1.2.1"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
SET @denominator_category_code = '4.27.1.2.2';
SET @source_kpi_id = (
...
SET @den_name = '异位妊娠手术总数_4.27.1.2';
CALL sp_kpi_item_create(@den_name, @cat_id, NULL, 'integer', 0, 'increase', 'value', NULL, IF(@source_kpi_id IS NOT NULL, NULL, @ds_id), IF(@source_kpi_id IS NOT NULL, NULL, @param),
    '异位妊娠手术总数', '无', '反映异位妊娠诊疗规范性', IF(@source_kpi_id IS NOT NULL, '与指标编码4.27.1.1.2（同期异位妊娠患者总例数）同源，采集源于该指标', '第四章-异位妊娠（手术治疗）质量控制查询'), NULL, 'full', NULL, NULL, '分子：符合异位妊娠手术指征患者数。分母：异位妊娠手术患者总例数。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', IF(@source_kpi_id IS NOT NULL, '同期异位妊娠患者总例数', '异位妊娠手术总数'), NULL, NULL, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
...
SET @kpi_name = '异位妊娠手术指征符合率';
CALL sp_kpi_item_create(@kpi_name, @cat_id, NULL, 'percent', 2, 'increase', 'ratio', NULL, @ds_id, @param,
    '符合异位妊娠手术指征患者数占异位妊娠手术患者总例数的比例', '无', '反映异位妊娠诊疗规范性', '第四章-异位妊娠（手术治疗）质量控制查询', NULL, 'full', NULL, NULL, '分子：符合异位妊娠手术指征患者数。分母：异位妊娠手术患者总例数。', '百分比（%）', '无', NULL, NULL,
    '出院日期', '出院科室名称', NULL, @num_id, @den_id, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @user, CONCAT('[{"category_id":', @cat_id, ',"category_code":"4.27.1.2"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL);
