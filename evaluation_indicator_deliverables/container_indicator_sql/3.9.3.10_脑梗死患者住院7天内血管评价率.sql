-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.10（与CSV文件中的编码完全一致）
-- 指标名称：脑梗死患者住院7天内血管评价率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.10.1）
SET @numerator_kpi_name = '住院7天内完善颈部和颅内血管评价的脑梗死患者数';
SET @numerator_category_code = '3.9.3.10.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '住院7天内完善颈部和颅内血管评价的脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '颈部血管评价指颈部血管超声检查、颈部CT血管成像（CTA）检查、颈部对比剂增强磁共振血管成像（CEMRA）检查或颈部数字减影血管造影（DSA）检查。 颅内血管评价指经颅多普勒（TCD）检查,头部CTA、MRA、DSA检查。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否7天内完善颈部和颅内血管评价的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.10.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期住院脑梗死患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '颈部血管评价指颈部血管超声检查、颈部CT血管成像（CTA）检查、颈部对比剂增强磁共振血管成像（CEMRA）检查或颈部数字减影血管造影（DSA）检查。 颅内血管评价指经颅多普勒（TCD）检查,头部CTA、MRA、DSA检查。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期脑梗死患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.3.10）
SET @kpi_name = '脑梗死患者住院7天内血管评价率';
SET @category_code = '3.9.3.10';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，脑梗死患者住院7天内完善颈部和颅内血管评价的人数占同期住院脑梗死患者的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '颈部血管评价指颈部血管超声检查、颈部CT血管成像（CTA）检查、颈部对比剂增强磁共振血管成像（CEMRA）检查或颈部数字减影血管造影（DSA）检查。 颅内血管评价指经颅多普勒（TCD）检查,头部CTA、MRA、DSA检查。', '百分比（%）', '无', NULL,
