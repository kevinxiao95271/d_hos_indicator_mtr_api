...
-- 创建分子指标（3.9.3.1.1）
SET @numerator_kpi_name = '进行神经功能评估的住院脑梗死患者数';
SET @numerator_category_code = '3.9.3.1.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进行神经功能评估的住院脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '美国国立卫生研究院卒中量表（NIHSS）参照《中国脑血管病临床管理指南》的中文翻译版本。 脑梗死即缺血性卒中，采用《中国脑血管病临床管理指南》定义，是指因脑部血液循环障碍，缺血、缺氧所致的局限性脑组织缺血性坏死或软化。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进行神经功能评估的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.3.1.2）
SET @denominator_kpi_name = '同期住院脑梗死病患者总数';
SET @denominator_category_code = '3.9.3.1.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期住院脑梗死病患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '美国国立卫生研究院卒中量表（NIHSS）参照《中国脑血管病临床管理指南》的中文翻译版本。 脑梗死即缺血性卒中，采用《中国脑血管病临床管理指南》定义，是指因脑部血液循环障碍，缺血、缺氧所致的局限性脑组织缺血性坏死或软化。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期脑梗死病患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.3.1）
SET @kpi_name = '脑梗死患者神经功能缺损评估率';
SET @category_code = '3.9.3.1';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，入院时采用美国国立卫生研究院卒中量表（NIHSS）进行神经功能缺损评估的脑梗死患者数，占同期住院脑梗死患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '美国国立卫生研究院卒中量表（NIHSS）参照《中国脑血管病临床管理指南》的中文翻译版本。 脑梗死即缺血性卒中，采用《中国脑血管病临床管理指南》定义，是指因脑部血液循环障碍，缺血、缺氧所致的局限性脑组织缺血性坏死或软化。', '百分比（%）', '无', NULL,
