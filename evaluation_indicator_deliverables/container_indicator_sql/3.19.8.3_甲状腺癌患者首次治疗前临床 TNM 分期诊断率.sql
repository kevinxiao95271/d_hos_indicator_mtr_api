...
CALL sp_kpi_item_create(
    ...
    '首次治疗前完成临床TNM分期诊断的甲状腺癌患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：首次治疗前完成临床TNM分期诊断的甲状腺癌患者数。分母：同期接受首次治疗的甲状腺癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否首次治疗前完成临床TNM分期诊断的甲状腺癌', NULL, NULL, NULL, NULL, 1.0000, 'sum',
