...
SET @numerator_kpi_name = '甲状腺癌术后血肿清除治疗患者数';
SET @numerator_category_code = '3.19.8.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '甲状腺癌术后血肿清除治疗患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：甲状腺癌术后血肿清除治疗患者数。分母：同期甲状腺癌手术患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否甲状腺癌术后血肿清除治疗', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.19.8.9.2';
CALL sp_kpi_item_create(
...
SET @kpi_name = '甲状腺癌术后血肿清除治疗率';
SET @category_code = '3.19.8.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '甲状腺癌术后血肿清除治疗率的定义和计算方法', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：甲状腺癌术后血肿清除治疗患者数。分母：同期甲状腺癌手术患者总数。', '百分比（%）', '无', NULL,
