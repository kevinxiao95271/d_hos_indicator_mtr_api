-- 4.18.1.1 入院氧合评估完成率（社区获得性肺炎成人）
-- 说明：分母编码 4.18.1.1.2（同期社区获得性肺炎患者总数）为 4.18.1 小节统一源分母；
--       4.18.1.2.2、4.18.1.5.2、4.18.1.6.2、4.18.2.1.2、4.18.2.2.2 与上述口径一致，注册脚本中采集源于本指标。
...
SET @num_name = 'CAP成人入院氧合评估完成患者数';
CALL sp_kpi_item_create(@num_name, @cat_id, NULL, 'integer', 0, 'increase', 'value', NULL, @ds_id, @param,
    '入院完成氧合评估患者数', '无', '反映肺炎评估的规范性', '第四章-社区获得性肺炎（成人，首次住院）质量控制查询', NULL, 'full', NULL, NULL, '分子：入院完成氧合评估患者数。分母：同期社区获得性肺炎患者总数。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', '入院完成氧合评估患者数', NULL, NULL, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @user, CONCAT('[{"category_id":', @cat_id, ',"category_code":"4.18.1.1.1"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
SET @den_name = '同期CAP成人患者总数_4.18.1.1';
CALL sp_kpi_item_create(@den_name, @cat_id, NULL, 'integer', 0, 'increase', 'value', NULL, @ds_id, @param,
    '同期社区获得性肺炎患者总数', '无', '反映肺炎评估的规范性', '第四章-社区获得性肺炎（成人，首次住院）质量控制查询', NULL, 'full', NULL, NULL, '分子：入院完成氧合评估患者数。分母：同期社区获得性肺炎患者总数。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', '同期社区获得性肺炎患者总数', NULL, NULL, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @user, CONCAT('[{"category_id":', @cat_id, ',"category_code":"4.18.1.1.2"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CALL sp_kpi_item_create(@kpi_name, @cat_id, NULL, 'percent', 2, 'increase', 'ratio', NULL, @ds_id, @param,
    '入院完成氧合评估患者数占同期社区获得性肺炎患者总数的比例', '无', '反映肺炎评估的规范性', '第四章-社区获得性肺炎（成人，首次住院）质量控制查询', NULL, 'full', NULL, NULL, '分子：入院完成氧合评估患者数。分母：同期社区获得性肺炎患者总数。', '百分比（%）', '无', NULL, NULL,
    '出院日期', '出院科室名称', NULL, @num_id, @den_id, NULL, NULL, 1.0000, 'sum', '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @user, CONCAT('[{"category_id":', @cat_id, ',"category_code":"4.18.1.1"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL);
