...
SET @numerator_kpi_name = '妊娠相关子宫切除人数';
SET @numerator_category_code = '3.8.8.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '妊娠相关子宫切除人数', '《产科专业医疗质量控制指标（2021年版）》。', '评价妊娠相关子宫切除发生情况',
    '产科专病表查询', NULL, '分子：妊娠相关子宫切除人数。分母：同期分娩产妇总人数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否妊娠相关子宫切除', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @kpi_name = '妊娠相关子宫切除率';
SET @category_code = '3.8.8';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'decimal', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，妊娠相关因素导致实施子宫切除人数占同期分娩产妇（分娩孕周≥28周）总人数的比例', '《产科专业医疗质量控制指标（2021年版）》。', '评价妊娠相关子宫切除发生情况',
    '产科专病表查询', NULL, '分子：妊娠相关子宫切除人数。分母：同期分娩产妇总人数。', '十万分比（1/100000）', '无', NULL,
