...
-- 创建分子指标（3.9.3.16.3.1）
SET @numerator_kpi_name = '出院时给予抗凝药物治疗的 合并房颤的脑梗死患者数';
SET @numerator_category_code = '3.9.3.16.3.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '出院时给予抗凝药物治疗的 合并房颤的脑梗死患者数', '', '',
    ...
    '出院日期', '出院科室名称', '是否出院时给予抗凝药物治疗的 合并房颤的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.3.16.3.2）
SET @denominator_kpi_name = '同期合并房颤的住院脑梗死患者总数';
SET @denominator_category_code = '3.9.3.16.3.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.3.16.3）
SET @kpi_name = '出院时合并房颤的脑梗死患者抗凝治疗率';
