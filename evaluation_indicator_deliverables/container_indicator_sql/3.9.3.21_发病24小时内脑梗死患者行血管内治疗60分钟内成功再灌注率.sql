-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.21（与CSV文件中的编码完全一致）
-- 指标名称：发病24小时内脑梗死患者行血管内治疗60分钟内成功再灌注率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.21.1）
SET @numerator_kpi_name = '发病24小时内脑梗死患者行血管内治疗从完成动脉穿刺到成功再灌注时间在60分钟内人数';
SET @numerator_category_code = '3.9.3.21.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内脑梗死患者行血管内治疗从完成动脉穿刺到成功再灌注时间在60分钟内人数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '成功再灌注指改良脑梗死溶栓分级（mTICI）为2b/3级。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否发病24小时内脑梗死患者行血管内治疗从完成动脉穿刺到成功再灌注时间在60分钟内', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.21.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.3.21）
SET @kpi_name = '发病24小时内脑梗死患者行血管内治疗60分钟内成功再灌注率';
SET @category_code = '3.9.3.21';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，发病24小时内脑梗死患者行血管内治疗者中，从完成动脉穿刺到成功再灌注时间（PRT）在60分钟内的患者所占比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '成功再灌注指改良脑梗死溶栓分级（mTICI）为2b/3级。', '百分比（%）', '无', NULL,
