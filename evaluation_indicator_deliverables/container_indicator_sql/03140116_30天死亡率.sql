-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.1.16（与CSV文件中的编码完全一致）
-- 指标名称：急性STEMI患者30天死亡率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.1.16.1）
SET @numerator_kpi_name = '确诊急性STEMI后30天死亡的急性STEMI患者数';
SET @numerator_category_code = '3.14.1.16.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '确诊急性STEMI后30天死亡的急性STEMI患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院STEMI诊疗的整体水平',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：确诊急性STEMI后30天死亡的急性STEMI患者数。分母：同期急性STEMI患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否确诊后30天死亡', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.1.16.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '急性STEMI患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院STEMI诊疗的整体水平',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：确诊急性STEMI后30天死亡的急性STEMI患者数。分母：同期急性STEMI患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.1.16）
SET @kpi_name = '急性STEMI患者30天死亡率';
SET @category_code = '3.14.1.16';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '确诊急性STEMI后30天死亡的急性STEMI患者数，占同期急性STEMI患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院STEMI诊疗的整体水平',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：确诊急性STEMI后30天死亡的急性STEMI患者数。分母：同期急性STEMI患者总数。', '百分比（%）', '无', NULL,
