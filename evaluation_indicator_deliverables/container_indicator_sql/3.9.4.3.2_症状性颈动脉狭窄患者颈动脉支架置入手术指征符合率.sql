-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.4.3.2（与CSV文件中的编码完全一致）
-- 指标名称：症状性颈动脉狭窄患者颈动脉支架置入手术指征符合率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.4.3.2.1）
SET @numerator_kpi_name = '症状性颈动脉狭窄患者行 颈动脉支架置入术符合手术指征治疗人数';
SET @numerator_category_code = '3.9.4.3.2.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '症状性颈动脉狭窄患者行 颈动脉支架置入术符合手术指征治疗人数', '', '',
    '颈动脉支架置入术专病表查询', NULL, '颈动脉支架置入术手术指征参照中华医学会外科学会《颈动脉狭窄诊治指南》（2017年版）。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否症状性颈动脉狭窄患者行 颈动脉支架置入术符合手术指征治疗', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.4.3.2.2）
SET @denominator_kpi_name = '同期症状性颈动脉狭窄患者行颈动脉支架置入术总人数';
SET @denominator_category_code = '3.9.4.3.2.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期症状性颈动脉狭窄患者行颈动脉支架置入术总人数', '', '',
    '颈动脉支架置入术专病表查询', NULL, '颈动脉支架置入术手术指征参照中华医学会外科学会《颈动脉狭窄诊治指南》（2017年版）。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期症状性颈动脉狭窄患者行颈动脉支架置入术总人数', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.4.3.2）
SET @kpi_name = '症状性颈动脉狭窄患者颈动脉支架置入手术指征符合率';
SET @category_code = '3.9.4.3.2';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，符合手术指征的颈动脉支架置入术患者数占颈动脉支架置入术患者总数的比例', '', '',
    '颈动脉支架置入术专病表查询', NULL, '颈动脉支架置入术手术指征参照中华医学会外科学会《颈动脉狭窄诊治指南》（2017年版）。', '百分比（%）', '无', NULL,
