...
SET @numerator_kpi_name = '使用有创机械通气治疗的慢阻肺急性加重患者死亡人数';
SET @numerator_category_code = '3.7.15.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '使用有创机械通气治疗的慢阻肺急性加重患者死亡人数', '《呼吸系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价使用有创机械通气的慢阻肺急性加重患者死亡情况',
    '慢阻肺急性加重专病表查询', NULL, '分子：使用有创机械通气治疗的慢阻肺急性加重患者死亡人数。分母：同期住院使用有创机械通气的慢阻肺急性加重患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否使用有创机械通气治疗的慢阻肺急性加重患者死亡', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期住院使用有创机械通气的慢阻肺急性加重患者总数';
SET @denominator_category_code = '3.7.15.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期住院使用有创机械通气的慢阻肺急性加重患者总数', '《呼吸系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价使用有创机械通气的慢阻肺急性加重患者死亡情况',
    '慢阻肺急性加重专病表查询', NULL, '分子：使用有创机械通气治疗的慢阻肺急性加重患者死亡人数。分母：同期住院使用有创机械通气的慢阻肺急性加重患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期住院使用有创机械通气的慢阻肺急性加重患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
SET @kpi_name = '使用有创机械通气的慢阻肺急性加重患者死亡率';
SET @category_code = '3.7.15';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，使用有创机械通气治疗的慢阻肺急性加重患者死亡人数占同期住院使用有创机械通气治疗的慢阻肺急性加重患者总数的比例', '《呼吸系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价使用有创机械通气的慢阻肺急性加重患者死亡情况',
    '慢阻肺急性加重专病表查询', NULL, '分子：使用有创机械通气治疗的慢阻肺急性加重患者死亡人数。分母：同期住院使用有创机械通气的慢阻肺急性加重患者总数。', '百分比（%）', '无', NULL,
