...
SET @numerator_kpi_name = '肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者数';
SET @numerator_category_code = '3.10.1.3.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者病理分型诊断的规范性',
    'IgA肾病专病表查询', NULL, '分子：肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者数。分母：同期完成肾脏病理诊断IgA肾脏患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否2周内完成病理分型诊断', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期完成肾脏病理诊断IgA肾脏患者总数';
SET @denominator_category_code = '3.10.1.3.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期完成肾脏病理诊断IgA肾脏患者总数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者病理分型诊断的规范性',
    'IgA肾病专病表查询', NULL, '分子：肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者数。分母：同期完成肾脏病理诊断IgA肾脏患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期IgA肾病患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
SET @kpi_name = 'IgA肾病患者病理分型诊断率';
SET @category_code = '3.10.1.3';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者比例', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者病理分型诊断的规范性',
    'IgA肾病专病表查询', NULL, '分子：肾活检术后2周内完成肾脏病理分型诊断的IgA肾病患者数。分母：同期完成肾脏病理诊断IgA肾脏患者总数。', '百分比（%）', '无', NULL,
