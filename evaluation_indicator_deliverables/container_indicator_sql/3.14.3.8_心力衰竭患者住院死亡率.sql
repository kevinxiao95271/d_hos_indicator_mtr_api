...
-- 创建分子指标（3.14.3.8.1）
SET @numerator_kpi_name = '住院期间死亡的心力衰竭患者数';
SET @numerator_category_code = '3.14.3.8.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '住院期间死亡的心力衰竭患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院心力衰竭诊疗的整体水平',
    '心力衰竭专病表查询', NULL, '分子：住院期间死亡的心力衰竭患者数。分母：同期心力衰竭患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.3.8）
SET @kpi_name = '心力衰竭患者住院死亡率';
SET @category_code = '3.14.3.8';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'monitor', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '住院期间死亡的心力衰竭患者数，占同期心力衰竭患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院心力衰竭诊疗的整体水平',
    '心力衰竭专病表查询', NULL, '分子：住院期间死亡的心力衰竭患者数。分母：同期心力衰竭患者总数。', '百分比（%）', '无', NULL,
