...
SET @numerator_kpi_name = '血压＜130/80mmHg的IgA肾病患者数';
SET @numerator_category_code = '3.10.1.6.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '血压＜130/80mmHg的IgA肾病患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者血压控制情况',
    'IgA肾病专病表查询', NULL, '分子：血压＜130/80mmHg的IgA肾病患者数。分母：同期随访的IgA肾病患者数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否血压控制达标', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期随访的IgA肾病患者数';
SET @denominator_category_code = '3.10.1.6.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期随访的IgA肾病患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者血压控制情况',
    'IgA肾病专病表查询', NULL, '分子：血压＜130/80mmHg的IgA肾病患者数。分母：同期随访的IgA肾病患者数。', '无', '无', NULL,
...
SET @kpi_name = 'IgA肾病患者血压控制达标率';
SET @category_code = '3.10.1.6';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '血压＜130/80mmHg的IgA肾病患者占同期随访的IgA肾病患者总数的比例', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者血压控制情况',
    'IgA肾病专病表查询', NULL, '分子：血压＜130/80mmHg的IgA肾病患者数。分母：同期随访的IgA肾病患者数。', '百分比（%）', '无', NULL,
