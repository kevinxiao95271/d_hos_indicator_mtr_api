...
-- 创建分子指标（3.9.1.4.1）
SET @numerator_kpi_name = '完成神经影像学及脑电图学相关检查的住院癫痫患者数';
SET @numerator_category_code = '3.9.1.4.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '完成神经影像学及脑电图学相关检查的住院癫痫患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '神经影像学检查指头部CT或核磁共振检查，脑电图学相关检查包括常规头皮脑电图监测或长程视频脑电图监测。癫痫患者病因学检查应完成神经影像学检查及脑电图学相关检查。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否完成神经影像学及脑电图学相关检查的癫痫', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.1.4.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.1.4）
SET @kpi_name = '癫痫患者病因学检查完成率';
SET @category_code = '3.9.1.4';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，住院癫痫患者完成神经影像学检查（如头颅CT 或核磁共振）及脑电图学相关检查（普通或视频长程脑电图）的人数占同期住院癫痫患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '神经影像学检查指头部CT或核磁共振检查，脑电图学相关检查包括常规头皮脑电图监测或长程视频脑电图监测。癫痫患者病因学检查应完成神经影像学检查及脑电图学相关检查。', '百分比（%）', '无', NULL,
