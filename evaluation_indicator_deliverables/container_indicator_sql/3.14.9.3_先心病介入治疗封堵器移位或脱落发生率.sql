-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.9.3（与CSV文件中的编码完全一致）
-- 指标名称：先心病介入治疗封堵器移位或脱落发生率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.9.3.1）
SET @numerator_kpi_name = '行先心病介入治疗发生封堵器移位或脱落的患者数';
SET @numerator_category_code = '3.14.9.3.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行先心病介入治疗发生封堵器移位或脱落的患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行先心病介入治疗发生封堵器移位或脱落的患者数。本指标适用于所有尝试行介入治疗的ASD、VSD及PDA患者。封堵器移位或脱落指ASD、VSD及PDA介入治疗术中或术后经影像学检查证实封堵器位置发生异常。包括：封堵器偏移造成残余分流；封堵器偏移导致房室瓣或半月瓣反流、右室流出道狭窄；封堵器脱入左右心房、左右心室、肺动脉、主动脉及其分支。分母：同期行先心病介入治疗的患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否发生封堵器移位或脱落', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.9.3.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期行先心病介入治疗的患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行先心病介入治疗发生封堵器移位或脱落的患者数。本指标适用于所有尝试行介入治疗的ASD、VSD及PDA患者。封堵器移位或脱落指ASD、VSD及PDA介入治疗术中或术后经影像学检查证实封堵器位置发生异常。包括：封堵器偏移造成残余分流；封堵器偏移导致房室瓣或半月瓣反流、右室流出道狭窄；封堵器脱入左右心房、左右心室、肺动脉、主动脉及其分支。分母：同期行先心病介入治疗的患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.9.3）
SET @kpi_name = '先心病介入治疗封堵器移位或脱落发生率';
SET @category_code = '3.14.9.3';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '行先心病介入治疗发生封堵器移位或脱落的患者数，占同期行先心病介入治疗的患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行先心病介入治疗发生封堵器移位或脱落的患者数。本指标适用于所有尝试行介入治疗的ASD、VSD及PDA患者。封堵器移位或脱落指ASD、VSD及PDA介入治疗术中或术后经影像学检查证实封堵器位置发生异常。包括：封堵器偏移造成残余分流；封堵器偏移导致房室瓣或半月瓣反流、右室流出道狭窄；封堵器脱入左右心房、左右心室、肺动脉、主动脉及其分支。分母：同期行先心病介入治疗的患者总数。', '百分比（%）', '无', NULL,
