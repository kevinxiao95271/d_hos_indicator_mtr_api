...
SET @numerator_kpi_name = '治疗6个月，血肌酐倍增的IgA肾病患者数';
SET @numerator_category_code = '3.10.1.7.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '治疗6个月，血肌酐倍增的IgA肾病患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者肾功能恶化情况',
    'IgA肾病专病表查询', NULL, '分子：治疗6个月，血肌酐倍增的IgA肾病患者数。分母：同期随访的IgA肾病患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否血肌酐倍增', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @kpi_name = '肾功能恶化率';
SET @category_code = '3.10.1.7';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '治疗6个月后，血肌酐倍增的IgA肾病患者比例', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者肾功能恶化情况',
    'IgA肾病专病表查询', NULL, '分子：治疗6个月，血肌酐倍增的IgA肾病患者数。分母：同期随访的IgA肾病患者总数。', '百分比（%）', '无', NULL,
