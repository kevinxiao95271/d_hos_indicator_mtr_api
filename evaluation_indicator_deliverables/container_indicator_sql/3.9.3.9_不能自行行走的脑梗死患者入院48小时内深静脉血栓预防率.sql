-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.9（与CSV文件中的编码完全一致）
-- 指标名称：不能自行行走的脑梗死患者入院48小时内深静脉血栓预防率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.9.1）
SET @numerator_kpi_name = '不能自行行走脑梗死患者入院48小时内给予深静脉血栓预防措施的人数';
SET @numerator_category_code = '3.9.3.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '不能自行行走脑梗死患者入院48小时内给予深静脉血栓预防措施的人数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '深静脉血栓预防措施包括药物预防（肝素或低分子肝素抗凝）、机械预防（肢体加压泵、梯度压力弹力袜等）以及下腔静脉滤器等。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否不能自行行走脑梗死患者入院48小时内给予深静脉血栓预防措施的', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.3.9.2）
SET @denominator_kpi_name = '同期不能自行行走住院脑梗死患者总数';
SET @denominator_category_code = '3.9.3.9.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期不能自行行走住院脑梗死患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '深静脉血栓预防措施包括药物预防（肝素或低分子肝素抗凝）、机械预防（肢体加压泵、梯度压力弹力袜等）以及下腔静脉滤器等。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期不能自行行走脑梗死患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.3.9）
SET @kpi_name = '不能自行行走的脑梗死患者入院48小时内深静脉血栓预防率';
SET @category_code = '3.9.3.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，不能自行行走的脑梗死患者入院48小时内给予深静脉血栓（DVT）预防措施的人数，占同期不能自行行走住院脑梗死患者的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '深静脉血栓预防措施包括药物预防（肝素或低分子肝素抗凝）、机械预防（肢体加压泵、梯度压力弹力袜等）以及下腔静脉滤器等。', '百分比（%）', '无', NULL,
