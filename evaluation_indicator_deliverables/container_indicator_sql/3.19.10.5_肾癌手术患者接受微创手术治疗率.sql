...
SET @numerator_kpi_name = '接受微创手术治疗的肾癌患者数';
SET @numerator_category_code = '3.19.10.5.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '接受微创手术治疗的肾癌患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '肾癌专病表查询', NULL, '分子：接受微创手术治疗的肾癌患者数。分母：同期接受手术治疗的肾癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否接受微创手术治疗的肾癌', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.19.10.5.2';
CALL sp_kpi_item_create(
...
SET @kpi_name = '肾癌手术患者接受微创手术治疗率';
SET @category_code = '3.19.10.5';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '肾癌手术患者接受微创手术治疗率的定义和计算方法', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '肾癌专病表查询', NULL, '分子：接受微创手术治疗的肾癌患者数。分母：同期接受手术治疗的肾癌患者总数。', '百分比（%）', '无', NULL,
