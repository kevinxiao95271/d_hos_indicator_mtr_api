-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.2.11（与CSV文件中的编码完全一致）
-- 指标名称：住院帕金森病患者焦虑症状和抑郁症状筛查率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.2.11.1）
SET @numerator_kpi_name = '进行焦虑症状和抑郁症状筛查的住院帕金森病患者数';
SET @numerator_category_code = '3.9.2.11.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进行焦虑症状和抑郁症状筛查的住院帕金森病患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '对住院帕金森病患者进行心理筛查主要包括焦虑和抑郁的筛查，参照国际运动障碍疾病协会推荐量表。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进行焦虑症状和抑郁症状筛查的帕金森病', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.2.11.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.2.11）
SET @kpi_name = '住院帕金森病患者焦虑症状和抑郁症状筛查率';
SET @category_code = '3.9.2.11';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，进行焦虑症状和抑郁症状筛查的住院帕金森病患者数占同期住院帕金森病患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '对住院帕金森病患者进行心理筛查主要包括焦虑和抑郁的筛查，参照国际运动障碍疾病协会推荐量表。', '百分比（%）', '无', NULL,
