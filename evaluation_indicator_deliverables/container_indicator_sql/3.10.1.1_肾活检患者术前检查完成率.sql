...
SET @numerator_kpi_name = '2周内完成术前检查的肾活检患者数';
SET @numerator_category_code = '3.10.1.1.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '2周内完成术前检查的肾活检患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价肾活检患者术前检查的规范性',
    'IgA肾病专病表查询', NULL, '分子：2周内完成术前检查的肾活检患者数。分母：同期肾活检患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否2周内完成术前检查', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期肾活检患者总数';
SET @denominator_category_code = '3.10.1.1.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期肾活检患者总数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价肾活检患者术前检查的规范性',
    'IgA肾病专病表查询', NULL, '分子：2周内完成术前检查的肾活检患者数。分母：同期肾活检患者总数。', '无', '无', NULL,
...
SET @kpi_name = '肾活检患者术前检查完成率';
SET @category_code = '3.10.1.1';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '肾活检患者2周内完成全部相关术前检查的比例', '《肾病专业医疗质量控制指标（2021年版）》。', '评价肾活检患者术前检查的规范性',
    'IgA肾病专病表查询', NULL, '分子：2周内完成术前检查的肾活检患者数。分母：同期肾活检患者总数。', '百分比（%）', '无', NULL,
