-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.4.8.2（与CSV文件中的编码完全一致）
-- 指标名称：颈动脉支架置入术患者出院他汀类药物治疗率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.4.8.2.1）
SET @numerator_kpi_name = '出院时给予他汀类药物治疗的颈动脉支架置入术患者数';
SET @numerator_category_code = '3.9.4.8.2.1';
CALL sp_kpi_item_create(
    ...
    '出院日期', '出院科室名称', '是否出院时给予他汀类药物治疗的颈动脉支架置入术', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.4.8.2.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.4.8.2）
SET @kpi_name = '颈动脉支架置入术患者出院他汀类药物治疗率';
SET @category_code = '3.9.4.8.2';
CALL sp_kpi_item_create(
