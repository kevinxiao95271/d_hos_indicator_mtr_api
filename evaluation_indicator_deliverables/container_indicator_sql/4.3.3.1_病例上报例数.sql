-- 第四章病种直报指标 4.3.3.1 - 冠状动脉旁路移植术病例上报例数
...
SET @data_source_param = '{"p_disease_code":"4.3"}';

SET @kpi_name = '冠状动脉旁路移植术病例上报例数';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', NULL, @data_source_id, @data_source_param,
    '报告至国家单病种质量监测平台的冠状动脉旁路移植术病例数', '《单病种系统接口规范》', '反映单病种病例向国家平台上报情况',
    ...
    @create_user, CONCAT('[{"category_id":', @category_id, ',"category_code":"4.3.3.1"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL
);
