...
-- 创建分子指标（3.14.3.9.1）
SET @numerator_kpi_name = '出院30天随访的心力衰竭患者数';
SET @numerator_category_code = '3.14.3.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '出院30天随访的心力衰竭患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对心力衰竭患者出院后的管理情况',
    '心力衰竭专病表查询', NULL, '分子：出院30天随访的心力衰竭患者数。随访方式包括但不限于电话随访、网络随访、门诊随访。分母：同期心力衰竭患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否出院30天随访', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.3.9.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '心力衰竭患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对心力衰竭患者出院后的管理情况',
    '心力衰竭专病表查询', NULL, '分子：出院30天随访的心力衰竭患者数。随访方式包括但不限于电话随访、网络随访、门诊随访。分母：同期心力衰竭患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.3.9）
SET @kpi_name = '心力衰竭患者出院30天随访率';
SET @category_code = '3.14.3.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '出院30天随访的心力衰竭患者数，占同期出院心力衰竭患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对心力衰竭患者出院后的管理情况',
    '心力衰竭专病表查询', NULL, '分子：出院30天随访的心力衰竭患者数。随访方式包括但不限于电话随访、网络随访、门诊随访。分母：同期心力衰竭患者总数。', '百分比（%）', '无', NULL,
