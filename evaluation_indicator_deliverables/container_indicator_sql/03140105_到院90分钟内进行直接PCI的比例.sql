-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.1.5（与CSV文件中的编码完全一致）
-- 指标名称：发病24小时内急性STEMI患者到院90分钟内进行直接经皮冠状动脉介入治疗（PCI）的比例
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.1.5.1）
SET @numerator_kpi_name = '发病24小时内急性STEMI患者中DTD的时间小于等于90分钟的患者数';
SET @numerator_category_code = '3.14.1.5.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内急性STEMI患者中DTD的时间小于等于90分钟的患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的及时性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内急性STEMI患者中DTD的时间小于等于90分钟的患者数。分母：同期发病24小时内急性STEMI患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否DTD时间小于等于90分钟', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间","到达医院接诊时间","再灌注治疗时间DTD"]',
...
-- 创建分母指标（3.14.1.5.2）
SET @denominator_kpi_name = '同期发病24小时内急性STEMI患者总数';
SET @denominator_category_code = '3.14.1.5.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内急性STEMI患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的及时性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内急性STEMI患者中DTD的时间小于等于90分钟的患者数。分母：同期发病24小时内急性STEMI患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期发病24小时内急性STEMI患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建比率指标（3.14.1.5）
SET @kpi_name = '发病24小时内急性STEMI患者到院90分钟内进行直接经皮冠状动脉介入治疗（PCI）的比例';
SET @category_code = '3.14.1.5';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内急性STEMI患者中，从到院至进行直接PCI治疗导丝通过靶血管（DTD）的时间≤90分钟的患者数，占同期发病24小时内急性STEMI患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的及时性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内急性STEMI患者中DTD的时间小于等于90分钟的患者数。分母：同期发病24小时内急性STEMI患者总数。', '百分比（%）', '无', NULL,
