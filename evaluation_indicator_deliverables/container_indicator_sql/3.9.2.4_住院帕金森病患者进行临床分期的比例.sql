-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.2.4（与CSV文件中的编码完全一致）
-- 指标名称：住院帕金森病患者进行临床分期的比例
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.2.4.1）
SET @numerator_kpi_name = '进行临床分期的住院帕金森病患者数';
SET @numerator_category_code = '3.9.2.4.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进行临床分期的住院帕金森病患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '临床分期是指Hoehn-Yahr分期：1期：累及单侧肢体；2期：双侧肢体症状但无平衡障碍；3期：轻至中度双侧症状，姿势不稳，不能从后拉试验中恢复，但可自理；4期：重度病残，不需要帮助仍能站立和行走；5期：坐轮椅或卧床，完全依赖别人帮助。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进行临床分期的帕金森病', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.2.4.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.2.4）
SET @kpi_name = '住院帕金森病患者进行临床分期的比例';
SET @category_code = '3.9.2.4';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，进行临床分期的住院帕金森病患者数占同期住院帕金森病患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '临床分期是指Hoehn-Yahr分期：1期：累及单侧肢体；2期：双侧肢体症状但无平衡障碍；3期：轻至中度双侧症状，姿势不稳，不能从后拉试验中恢复，但可自理；4期：重度病残，不需要帮助仍能站立和行走；5期：坐轮椅或卧床，完全依赖别人帮助。', '百分比（%）', '无', NULL,
