...
SET @numerator_kpi_name = '住院期间CAP患者抗感染治疗前病原学送检人数';
SET @numerator_category_code = '3.7.18.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '住院期间CAP患者抗感染治疗前病原学送检人数', '《呼吸系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价CAP患者抗感染治疗的规范性',
    '成人社区获得性肺炎专病表查询', NULL, '分子：住院期间CAP患者抗感染治疗前病原学送检人数。分母：同期住院CAP患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否住院期间CAP患者抗感染治疗前病原学送检', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @kpi_name = 'CAP患者住院期间抗感染治疗前病原学送检比例';
SET @category_code = '3.7.18';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，住院CAP患者抗感染治疗前病原学送检人数占同期住院CAP患者总数的比例', '《呼吸系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价CAP患者抗感染治疗的规范性',
    '成人社区获得性肺炎专病表查询', NULL, '分子：住院期间CAP患者抗感染治疗前病原学送检人数。分母：同期住院CAP患者总数。', '百分比（%）', '无', NULL,
