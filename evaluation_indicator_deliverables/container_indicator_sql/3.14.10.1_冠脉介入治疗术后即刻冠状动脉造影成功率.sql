-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.10.1（与CSV文件中的编码完全一致）
-- 指标名称：冠脉介入治疗术后即刻冠状动脉造影成功率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.10.1.1）
SET @numerator_kpi_name = '冠脉介入治疗术后即刻冠状动脉造影成功的例数';
SET @numerator_category_code = '3.14.10.1.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '冠脉介入治疗术后即刻冠状动脉造影成功的例数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '冠心病介入治疗专病表查询', NULL, '分子：冠脉介入治疗术后即刻冠状动脉造影成功的例数。冠状动脉造影成功是指支架术后病变残余狭窄<20%或单纯经皮冠状动脉腔内血管成形术（PTCA）后病变残余狭窄<50%，且冠状动脉血流心肌梗死溶栓（TIMI）分级3级。分母：同期接受冠脉介入治疗的总例数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否术后即刻冠状动脉造影成功', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.10.1.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.14.10.1）
SET @kpi_name = '冠脉介入治疗术后即刻冠状动脉造影成功率';
SET @category_code = '3.14.10.1';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '冠脉介入治疗术后即刻冠状动脉造影成功的例数，占同期接受冠脉介入治疗的总例数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '冠心病介入治疗专病表查询', NULL, '分子：冠脉介入治疗术后即刻冠状动脉造影成功的例数。冠状动脉造影成功是指支架术后病变残余狭窄<20%或单纯经皮冠状动脉腔内血管成形术（PTCA）后病变残余狭窄<50%，且冠状动脉血流心肌梗死溶栓（TIMI）分级3级。分母：同期接受冠脉介入治疗的总例数。', '百分比（%）', '无', NULL,
