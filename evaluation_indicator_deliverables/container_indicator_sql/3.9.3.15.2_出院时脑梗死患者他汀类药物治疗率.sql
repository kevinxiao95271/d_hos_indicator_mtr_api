-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.15.2（与CSV文件中的编码完全一致）
-- 指标名称：出院时脑梗死患者他汀类药物治疗率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.15.2.1）
SET @numerator_kpi_name = '出院时给予他汀药物治疗的脑梗死患者数';
SET @numerator_category_code = '3.9.3.15.2.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '出院时给予他汀药物治疗的脑梗死患者数', '', '',
    '脑梗死专病表查询', NULL, '《中国缺血性脑卒中和短暂性脑缺血发作二级预防指南2014》推荐意见：对非心源性栓塞性缺血性脑卒中或TIA患者，建议给予口服抗血小板药物而非抗凝药物预防脑卒中复发及其他心血管事件的发生（I级推荐，A级证据）。伴有主动脉弓动脉粥样硬化斑块证据的缺血性脑卒中或TIA患者，推荐抗血小板及他汀类药物治疗（Ⅱ级推荐，B级证据）。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否出院时给予他汀药物治疗的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.15.2.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.3.15.2）
SET @kpi_name = '出院时脑梗死患者他汀类药物治疗率';
SET @category_code = '3.9.3.15.2';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，出院时给予他汀类药物治疗的脑梗死患者数占同期住院脑梗死患者总数的比例。', '', '',
    '脑梗死专病表查询', NULL, '《中国缺血性脑卒中和短暂性脑缺血发作二级预防指南2014》推荐意见：对非心源性栓塞性缺血性脑卒中或TIA患者，建议给予口服抗血小板药物而非抗凝药物预防脑卒中复发及其他心血管事件的发生（I级推荐，A级证据）。伴有主动脉弓动脉粥样硬化斑块证据的缺血性脑卒中或TIA患者，推荐抗血小板及他汀类药物治疗（Ⅱ级推荐，B级证据）。', '百分比（%）', '无', NULL,
