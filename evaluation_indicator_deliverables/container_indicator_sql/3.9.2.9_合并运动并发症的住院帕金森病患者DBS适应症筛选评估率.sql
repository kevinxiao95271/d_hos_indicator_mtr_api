-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.2.9（与CSV文件中的编码完全一致）
-- 指标名称：合并运动并发症的住院帕金森病患者DBS适应症筛选评估率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.2.9.1）
SET @numerator_kpi_name = '进行DBS筛查的合并运动并发症的住院 帕金森病患者数';
SET @numerator_category_code = '3.9.2.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进行DBS筛查的合并运动并发症的住院 帕金森病患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, 'DBS适应症筛选评估方法参照中华医学会脑深部电刺激治疗帕金森病的专家共识。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进行DBS筛查的合并运动并发症的 帕金森病', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.2.9.2）
SET @denominator_kpi_name = '同期合并运动并发症的住院帕金森病患者总数';
SET @denominator_category_code = '3.9.2.9.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期合并运动并发症的住院帕金森病患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, 'DBS适应症筛选评估方法参照中华医学会脑深部电刺激治疗帕金森病的专家共识。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期合并运动并发症的帕金森病患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.2.9）
SET @kpi_name = '合并运动并发症的住院帕金森病患者DBS适应症筛选评估率';
SET @category_code = '3.9.2.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '进行DBS（脑深部电刺激）适应症筛选评估的合并运动并发症的住院帕金森病患者数占同期合并运动并发症的住院帕金森病患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, 'DBS适应症筛选评估方法参照中华医学会脑深部电刺激治疗帕金森病的专家共识。', '百分比（%）', '无', NULL,
