...
-- 专病表接口指标注册脚本
-- 指标编码：3.19.8.4
-- 指标名称：甲状腺癌患者首次治疗前临床 TNM 分期检查评估策略符合率
-- 创建日期：2026-03-09
-- ===========================================
...
CALL sp_kpi_item_create(
    ...
    '首次治疗前临床TNM分期检查评估符合策略的甲状腺癌患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：首次治疗前临床TNM分期检查评估符合策略的甲状腺癌患者数。分母：同期接受首次治疗的甲状腺癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否首次治疗前临床TNM分期检查评估符合策略的甲状腺癌', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
CALL sp_kpi_item_create(
    ...
    '同期接受首次治疗的甲状腺癌患者总数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：首次治疗前临床TNM分期检查评估符合策略的甲状腺癌患者数。分母：同期接受首次治疗的甲状腺癌患者总数。', '无', '无', NULL,
...
SET @kpi_name = '甲状腺癌患者首次治疗前临床 TNM 分期检查评估策略符合率';
SET @category_code = '3.19.8.4';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '甲状腺癌患者首次治疗前临床 TNM 分期检查评估策略符合率的定义和计算方法', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
