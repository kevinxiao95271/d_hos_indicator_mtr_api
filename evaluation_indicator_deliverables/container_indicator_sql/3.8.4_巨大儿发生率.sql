...
SET @numerator_kpi_name = '巨大儿人数';
SET @numerator_category_code = '3.8.4.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '巨大儿人数', '《产科专业医疗质量控制指标（2021年版）》。', '评价巨大儿发生情况',
    '产科专病表查询', NULL, '分子：巨大儿人数。分母：同期活产数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否巨大儿', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @kpi_name = '巨大儿发生率';
SET @category_code = '3.8.4';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，巨大儿（出生体重≥4000g）人数占同期活产数的比例', '《产科专业医疗质量控制指标（2021年版）》。', '评价巨大儿发生情况',
    '产科专病表查询', NULL, '分子：巨大儿人数。分母：同期活产数。', '百分比（%）', '无', NULL,
