-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.11（与CSV文件中的编码完全一致）
-- 指标名称：住院期间脑梗死患者他汀类药物治疗率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.11.1）
SET @numerator_kpi_name = '住院期间使用他汀类药物治疗的脑梗死患者数';
SET @numerator_category_code = '3.9.3.11.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '住院期间使用他汀类药物治疗的脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '《中国脑血管病临床管理指南2019》中，“9.2脂代谢异常的管理”，对于符合接受他汀类药物治疗条件的患者，在医院内启动他汀类药物治疗是合理的（Ⅱa类推荐，C级证据）。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否期间使用他汀类药物治疗的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.11.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.3.11）
SET @kpi_name = '住院期间脑梗死患者他汀类药物治疗率';
SET @category_code = '3.9.3.11';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，住院期间使用他汀类药物治疗的脑梗死患者数占同期住院脑梗死患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '《中国脑血管病临床管理指南2019》中，“9.2脂代谢异常的管理”，对于符合接受他汀类药物治疗条件的患者，在医院内启动他汀类药物治疗是合理的（Ⅱa类推荐，C级证据）。', '百分比（%）', '无', NULL,
