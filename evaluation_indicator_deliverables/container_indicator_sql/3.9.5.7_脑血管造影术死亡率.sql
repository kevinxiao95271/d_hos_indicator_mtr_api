...
-- 创建分子指标（3.9.5.7.1）
SET @numerator_kpi_name = '脑血管造影术后住院期间死亡患者数';
SET @numerator_category_code = '3.9.5.7.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '脑血管造影术后住院期间死亡患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.脑血管造影术中非离子型对比剂的应用率', '反映医疗机构脑血管造影术的患者术前规范化评估现状。',
    '脑血管造影术专病表查询', NULL, '脑血管造影术后住院期间死亡以病案首页信息为依据。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否脑血管造影术后期间死亡', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.5.7.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.5.7）
SET @kpi_name = '脑血管造影术死亡率';
SET @category_code = '3.9.5.7';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，脑血管造影术后住院期间死亡患者数占行脑血管造影术的患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.脑血管造影术中非离子型对比剂的应用率', '反映医疗机构脑血管造影术的患者术前规范化评估现状。',
    '脑血管造影术专病表查询', NULL, '脑血管造影术后住院期间死亡以病案首页信息为依据。', '百分比（%）', '无', NULL,
