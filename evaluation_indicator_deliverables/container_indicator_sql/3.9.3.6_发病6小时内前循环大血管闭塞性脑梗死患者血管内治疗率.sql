-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.6（与CSV文件中的编码完全一致）
-- 指标名称：发病6小时内前循环大血管闭塞性脑梗死患者血管内治疗率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.6.1）
SET @numerator_kpi_name = '发病6小时内行血管内治疗的前循环大血管闭塞性脑梗死患者数';
SET @numerator_category_code = '3.9.3.6.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病6小时内行血管内治疗的前循环大血管闭塞性脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否发病6小时内行血管内治疗的前循环大血管闭塞性脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.3.6.2）
SET @denominator_kpi_name = '同期发病6小时到院的前循环大血管闭塞的脑梗死患者总数';
SET @denominator_category_code = '3.9.3.6.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期发病6小时到院的前循环大血管闭塞的脑梗死患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期发病6小时到院的前循环大血管闭塞的脑梗死患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.3.6）
SET @kpi_name = '发病6小时内前循环大血管闭塞性脑梗死患者血管内治疗率';
SET @category_code = '3.9.3.6';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，在发病6小时内行血管内治疗的前循环大血管闭塞性脑梗死患者数，占同期发病6小时内到院的前循环大血管闭塞的脑梗死患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
