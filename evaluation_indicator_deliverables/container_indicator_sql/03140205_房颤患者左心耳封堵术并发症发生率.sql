-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.2.5（与CSV文件中的编码完全一致）
-- 指标名称：房颤患者左心耳封堵术并发症发生率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.2.5.1）
SET @numerator_kpi_name = '左心耳封堵术中及术后发生并发症的房颤患者数';
SET @numerator_category_code = '3.14.2.5.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '左心耳封堵术中及术后发生并发症的房颤患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价房颤左心耳封堵手术安全性',
    '心房颤动专病表查询', NULL, '分子：左心耳封堵术中及术后发生并发症的房颤患者数。左心耳封堵术并发症指：①影像学检查确诊的穿刺部位假性动脉瘤；②影像学检查确诊的穿刺部位动静脉瘘；③左心耳封堵术中以及术后72小时内新发或增多的心包积液，且合并下列情况之一：行心包穿刺引流、行外科修补；④术中及术后72小时内的脑卒中；⑤封堵器脱位。分母：同期行左心耳封堵的房颤患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否左心耳封堵术并发症_房颤', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间","左心耳封堵时间"]',
...
-- 创建分母指标（3.14.2.5.2）
SET @denominator_kpi_name = '同期行左心耳封堵的房颤患者总数';
SET @denominator_category_code = '3.14.2.5.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行左心耳封堵的房颤患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价房颤左心耳封堵手术安全性',
    '心房颤动专病表查询', NULL, '分子：左心耳封堵术中及术后发生并发症的房颤患者数。左心耳封堵术并发症指：①影像学检查确诊的穿刺部位假性动脉瘤；②影像学检查确诊的穿刺部位动静脉瘘；③左心耳封堵术中以及术后72小时内新发或增多的心包积液，且合并下列情况之一：行心包穿刺引流、行外科修补；④术中及术后72小时内的脑卒中；⑤封堵器脱位。分母：同期行左心耳封堵的房颤患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期行左心耳封堵的房颤患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间","左心耳封堵时间"]',
...
-- 创建比率指标（3.14.2.5）
SET @kpi_name = '房颤患者左心耳封堵术并发症发生率';
SET @category_code = '3.14.2.5';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '左心耳封堵术中及术后发生并发症的房颤患者数，占同期行左心耳封堵的房颤患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价房颤左心耳封堵手术安全性',
    '心房颤动专病表查询', NULL, '分子：左心耳封堵术中及术后发生并发症的房颤患者数。左心耳封堵术并发症指：①影像学检查确诊的穿刺部位假性动脉瘤；②影像学检查确诊的穿刺部位动静脉瘘；③左心耳封堵术中以及术后72小时内新发或增多的心包积液，且合并下列情况之一：行心包穿刺引流、行外科修补；④术中及术后72小时内的脑卒中；⑤封堵器脱位。分母：同期行左心耳封堵的房颤患者总数。', '百分比（%）', '无', NULL,
