...
-- 创建分子指标（3.9.1.3.1）
SET @numerator_kpi_name = '病程中发生抗癫痫药物严重不良反应的住院癫痫患者人次数';
SET @numerator_category_code = '3.9.1.3.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '病程中发生抗癫痫药物严重不良反应的住院癫痫患者人次数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '抗癫痫药物严重不良反应指：使用抗癫痫药物后导致患者需前往门诊就诊，并减药、停药或对症处理；或导致患者需要住院治疗；或住院时间延长；或导致胎儿先天性畸形或出生缺陷。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否病程中发生抗癫痫药物严重不良反应的癫痫患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.1.3.2）
SET @denominator_kpi_name = '同期住院癫痫患者总人次数';
SET @denominator_category_code = '3.9.1.3.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期住院癫痫患者总人次数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '抗癫痫药物严重不良反应指：使用抗癫痫药物后导致患者需前往门诊就诊，并减药、停药或对症处理；或导致患者需要住院治疗；或住院时间延长；或导致胎儿先天性畸形或出生缺陷。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期癫痫患者患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.9.1.3）
SET @kpi_name = '抗癫痫药物严重不良反应发生率';
SET @category_code = '3.9.1.3';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，住院癫痫患者病程中发生抗癫痫药物严重不良反应的人次数与同期住院癫痫患者总人次数的比值。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '抗癫痫药物严重不良反应指：使用抗癫痫药物后导致患者需前往门诊就诊，并减药、停药或对症处理；或导致患者需要住院治疗；或住院时间延长；或导致胎儿先天性畸形或出生缺陷。', '百分比（%）', '无', NULL,
