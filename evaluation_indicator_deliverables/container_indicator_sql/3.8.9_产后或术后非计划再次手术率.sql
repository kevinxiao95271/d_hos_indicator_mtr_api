...
SET @numerator_kpi_name = '产后或术后非计划再次手术人数';
SET @numerator_category_code = '3.8.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '产后或术后非计划再次手术人数', '《产科专业医疗质量控制指标（2021年版）》。', '评价产后或术后非计划再次手术发生情况',
    '产科专病表查询', NULL, '分子：产后或术后非计划再次手术人数。分母：同期分娩产妇总人数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否产后或术后非计划再次手术', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @kpi_name = '产后或术后非计划再次手术率';
SET @category_code = '3.8.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'decimal', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，产妇在同一次住院期间，产后或术后因各种原因导致患者需重返手术室进行计划外再次手术（含介入手术）的人数占同期分娩产妇（分娩孕周≥28周）总人数的比例', '《产科专业医疗质量控制指标（2021年版）》。', '评价产后或术后非计划再次手术发生情况',
    '产科专病表查询', NULL, '分子：产后或术后非计划再次手术人数。分母：同期分娩产妇总人数。', '十万分比（1/100000）', '无', NULL,
