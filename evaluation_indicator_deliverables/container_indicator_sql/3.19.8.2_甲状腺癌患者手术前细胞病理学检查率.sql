...
SET @numerator_kpi_name = '甲状腺癌手术治疗前完成细胞病理学检查的患者数';
SET @numerator_category_code = '3.19.8.2.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '甲状腺癌手术治疗前完成细胞病理学检查的患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：甲状腺癌手术治疗前完成细胞病理学检查的患者数。分母：同期接受手术治疗的甲状腺癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否甲状腺癌手术治疗前完成细胞病理学检查的', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.19.8.2.2';
CALL sp_kpi_item_create(
...
SET @kpi_name = '甲状腺癌患者手术前细胞病理学检查率';
SET @category_code = '3.19.8.2';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '甲状腺癌患者手术前细胞病理学检查率的定义和计算方法', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '甲状腺癌专病表查询', NULL, '分子：甲状腺癌手术治疗前完成细胞病理学检查的患者数。分母：同期接受手术治疗的甲状腺癌患者总数。', '百分比（%）', '无', NULL,
