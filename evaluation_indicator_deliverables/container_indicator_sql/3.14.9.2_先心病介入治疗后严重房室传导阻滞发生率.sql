-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.9.2（与CSV文件中的编码完全一致）
-- 指标名称：先心病介入治疗后严重房室传导阻滞发生率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.9.2.1）
SET @numerator_kpi_name = '行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数';
SET @numerator_category_code = '3.14.9.2.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数。本指标适用于所有尝试行介入治疗的ASD/VSD患者。严重房室传导阻滞指二度Ⅱ型、高度和三度房室传导阻滞。分母：同期行ASD/VSD介入治疗的患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否术中或术后发生严重房室传导阻滞_ASD或VSD', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.14.9.2.2）
SET @denominator_kpi_name = '同期行ASD/VSD介入治疗的患者总数';
SET @denominator_category_code = '3.14.9.2.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期行ASD/VSD介入治疗的患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数。本指标适用于所有尝试行介入治疗的ASD/VSD患者。严重房室传导阻滞指二度Ⅱ型、高度和三度房室传导阻滞。分母：同期行ASD/VSD介入治疗的患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期行ASD或VSD介入治疗的患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.14.9.2）
SET @kpi_name = '先心病介入治疗后严重房室传导阻滞发生率';
SET @category_code = '3.14.9.2';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数，占同期行ASD/VSD介入治疗的患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '先心病介入治疗专病表查询', NULL, '分子：行ASD/VSD介入治疗术中或术后发生严重房室传导阻滞的患者数。本指标适用于所有尝试行介入治疗的ASD/VSD患者。严重房室传导阻滞指二度Ⅱ型、高度和三度房室传导阻滞。分母：同期行ASD/VSD介入治疗的患者总数。', '百分比（%）', '无', NULL,
