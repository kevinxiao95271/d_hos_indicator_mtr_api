...
-- 创建分子指标（3.14.6.8.1）
SET @numerator_kpi_name = '行二尖瓣手术出院使用抗凝药物的患者数';
SET @numerator_category_code = '3.14.6.8.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行二尖瓣手术出院使用抗凝药物的患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价二尖瓣手术二级预防情况',
    '二尖瓣手术专病表查询', NULL, '分子：行二尖瓣手术出院使用抗凝药物的患者数。分母：同期行二尖瓣手术的患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否出院使用抗凝药物', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.6.8.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'monitor', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行二尖瓣手术的患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价二尖瓣手术二级预防情况',
    '二尖瓣手术专病表查询', NULL, '分子：行二尖瓣手术出院使用抗凝药物的患者数。分母：同期行二尖瓣手术的患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.6.8）
SET @kpi_name = '二尖瓣手术出院抗凝药物使用率';
SET @category_code = '3.14.6.8';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'monitor', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '行二尖瓣手术出院使用抗凝药物的患者数，占同期行二尖瓣手术的患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价二尖瓣手术二级预防情况',
    '二尖瓣手术专病表查询', NULL, '分子：行二尖瓣手术出院使用抗凝药物的患者数。分母：同期行二尖瓣手术的患者总数。', '百分比（%）', '无', NULL,
