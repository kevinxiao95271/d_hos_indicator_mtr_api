-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.1.12（与CSV文件中的编码完全一致）
-- 指标名称：惊厥性癫痫持续状态初始治疗标准方案应用率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.1.12.1）
SET @numerator_kpi_name = '应用标准初始治疗方案治疗的住院 惊厥性癫痫持续状态患者数';
SET @numerator_category_code = '3.9.1.12.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '应用标准初始治疗方案治疗的住院 惊厥性癫痫持续状态患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '初始治疗方案参考《成人全面性惊厥性癫痫持续状态治疗中国专家共识》。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否应用标准初始治疗方案治疗的 惊厥性癫痫持续状态', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.1.12.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.1.12）
SET @kpi_name = '惊厥性癫痫持续状态初始治疗标准方案应用率';
SET @category_code = '3.9.1.12';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，住院惊厥性癫痫持续状态患者中应用指南推荐的初始治疗标准方案治疗的患者数占同期住院惊厥性癫痫持续状态患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '初始治疗方案参考《成人全面性惊厥性癫痫持续状态治疗中国专家共识》。', '百分比（%）', '无', NULL,
