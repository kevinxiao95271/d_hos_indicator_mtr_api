...
-- 创建分子指标（3.9.3.14.1）
SET @numerator_kpi_name = '进行康复评估的住院脑梗死患者数';
SET @numerator_category_code = '3.9.3.14.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进行康复评估的住院脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '康复评估是指康复科、康复治疗中心、多学科组成的卒中康复治疗小组或者康复专业人员给予的全面身体状况评估。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进行康复评估的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.9.3.14.2）
SET @denominator_kpi_name = '同期脑梗死住院患者总数';
SET @denominator_category_code = '3.9.3.14.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期脑梗死住院患者总数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '康复评估是指康复科、康复治疗中心、多学科组成的卒中康复治疗小组或者康复专业人员给予的全面身体状况评估。', '无', '无', NULL,
...
-- 创建比率指标（3.9.3.14）
SET @kpi_name = '脑梗死患者康复评估率';
SET @category_code = '3.9.3.14';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，进行康复评估的住院脑梗死患者数，占同期住院治疗的脑梗死患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '康复评估是指康复科、康复治疗中心、多学科组成的卒中康复治疗小组或者康复专业人员给予的全面身体状况评估。', '百分比（%）', '无', NULL,
