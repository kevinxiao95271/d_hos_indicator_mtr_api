...
-- 创建分子指标（3.14.10.5.1）
SET @numerator_kpi_name = '接受冠脉介入治疗住院期间发生严重并发症的患者数';
SET @numerator_category_code = '3.14.10.5.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '接受冠脉介入治疗住院期间发生严重并发症的患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '冠心病介入治疗专病表查询', NULL, '分子：接受冠脉介入治疗住院期间发生严重并发症的患者数。严重并发症是指急性心肌梗死、急性或亚急性支架内血栓、心脏压塞、恶性心律失常、需要输血或危及生命的出血事件。分母：同期接受冠脉介入治疗的患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否住院期间发生严重并发症', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.10.5.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.14.10.5）
SET @kpi_name = '冠脉介入治疗严重并发症发生率';
SET @category_code = '3.14.10.5';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '接受冠脉介入治疗住院期间发生严重并发症的患者数，占同期接受冠脉介入治疗的患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价手术诊疗质量情况',
    '冠心病介入治疗专病表查询', NULL, '分子：接受冠脉介入治疗住院期间发生严重并发症的患者数。严重并发症是指急性心肌梗死、急性或亚急性支架内血栓、心脏压塞、恶性心律失常、需要输血或危及生命的出血事件。分母：同期接受冠脉介入治疗的患者总数。', '百分比（%）', '无', NULL,
