-- 4.2.1.5 病死率（心力衰竭）
-- 分母 4.2.1.5.2 源于 4.2.1.1.2，须先执行 4.2.1.1_心脏功能评估率.sql
...
SET @numerator_kpi_name = '某病种的死亡人数_心力衰竭';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', NULL, @data_source_id, @data_source_param,
    '心力衰竭死亡人数', '无', '评价心力衰竭结局',
    '第四章-心力衰竭质量控制查询', NULL, 'full', NULL, NULL, '分子：某病种的死亡人数。分母：同期某病种出院总人数。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', '心力衰竭死亡人数', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @create_user, CONCAT('[{"category_id":', @category_id, ',"category_code":"4.2.1.5.1"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL
);
SET @numerator_kpi_id = (SELECT ID FROM KPI_ITEM WHERE KPI_NAME = @numerator_kpi_name AND INVALID = 0 AND KPI_TYPE = 'value' ORDER BY CREATE_TIME DESC LIMIT 1);

SET @denominator_kpi_name = '同期某病种出院总人数_4.2.1.5';
SET @source_kpi_id = (
...
CALL sp_kpi_item_create(
    ...
    '同期心力衰竭出院总人数', '无', '评价心力衰竭结局',
    IF(@source_kpi_id IS NOT NULL, '与指标编码4.2.1.1.2（同期心力衰竭患者总数）同源，采集源于该指标', '第四章-心力衰竭质量控制查询'), NULL, 'full', NULL, NULL,
    '分子：某病种的死亡人数。分母：同期某病种出院总人数（与4.2.1.1.2一致）。', '无', '无', NULL, NULL,
    '出院日期', '出院科室名称', IF(@source_kpi_id IS NOT NULL, '同期心力衰竭患者总数', '同期心力衰竭出院总人数'), NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @create_user, CONCAT('[{"category_id":', @category_id, ',"category_code":"4.2.1.5.2"}]'),
...
CALL sp_kpi_item_create(
    ...
    '心力衰竭死亡人数占同期心力衰竭出院总人数的比例', '无', '评价心力衰竭结局',
    '第四章-心力衰竭质量控制查询', NULL, 'full', NULL, NULL, '分子：4.2.1.5.1 某病种的死亡人数。分母：4.2.1.5.2 同期某病种出院总人数。', '百分比（%）', '无', NULL, NULL,
    '出院日期', '出院科室名称', NULL, @numerator_kpi_id, @denominator_kpi_id, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称"]', '[]', '["患者ID","住院号","病案号","出院时间"]',
    @create_user, CONCAT('[{"category_id":', @category_id, ',"category_code":"4.2.1.5"}]'), NULL, NULL, NULL, NULL, NULL, NULL, NULL
);
