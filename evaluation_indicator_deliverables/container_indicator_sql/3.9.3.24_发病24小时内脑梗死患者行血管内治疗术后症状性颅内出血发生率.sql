-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.9.3.24（与CSV文件中的编码完全一致）
-- 指标名称：发病24小时内脑梗死患者行血管内治疗术后症状性颅内出血发生率
-- 创建日期：2026-02-05
-- ===========================================
...
-- 创建分子指标（3.9.3.24.1）
SET @numerator_kpi_name = '发病24小时内脑梗死患者行血管内治疗术后住院期间发生症状性颅内出血人数';
SET @numerator_category_code = '3.9.3.24.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内脑梗死患者行血管内治疗术后住院期间发生症状性颅内出血人数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '症状性颅内出血指术后CT扫描显示脑出血或蛛网膜下腔出血，神经功能缺损加重NIHSS评分增加≥4分或死亡。 反映医疗机构发病24小时内脑梗死患者行血管内治疗临床结局。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否发病24小时内脑梗死患者行血管内治疗术后期间发生症状性颅内出血', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.24.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.3.24）
SET @kpi_name = '发病24小时内脑梗死患者行血管内治疗术后症状性颅内出血发生率';
SET @category_code = '3.9.3.24';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，发病24小时内脑梗死患者行血管内治疗者中，术后住院期间发生症状性颅内出血（sICH）的患者所占比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '症状性颅内出血指术后CT扫描显示脑出血或蛛网膜下腔出血，神经功能缺损加重NIHSS评分增加≥4分或死亡。 反映医疗机构发病24小时内脑梗死患者行血管内治疗临床结局。', '百分比（%）', '无', NULL,
