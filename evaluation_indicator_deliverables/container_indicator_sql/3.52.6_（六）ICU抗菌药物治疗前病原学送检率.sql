-- ===========================================
-- 0352 专病表指标注册脚本
-- 指标编码：3.52.6（六）ICU抗菌药物治疗前病原学送检率
-- 数据源：重症医学专病表查询
-- ===========================================
...
SET @numerator_kpi_name = '以治疗为目的使用抗菌药物前病原学送检的ICU患者人数';
SET @numerator_category_code = '3.52.6.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', NULL, @data_source_id, '{"p_date_type":"out"}',
    '以治疗为目的使用抗菌药物前病原学送检的ICU患者人数', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU患者抗菌药物使用的规范性',
    '重症医学专病表查询', NULL, 'full', '分子：以治疗为目的使用抗菌药物前病原学送检的ICU患者人数。分母：同期使用抗菌药物治疗的ICU患者总人数。', '无', '无', NULL, '无', '无', '无',
    '出院日期', '出院科室名称', '是否ICU住院患者使用抗菌药物前病原学送检', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期使用抗菌药物治疗的ICU患者总人数';
SET @denominator_category_code = '3.52.6.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', NULL, @data_source_id, '{"p_date_type":"out"}',
    '同期使用抗菌药物治疗的ICU患者总人数', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU患者抗菌药物使用的规范性',
    '重症医学专病表查询', NULL, 'full', '分子：以治疗为目的使用抗菌药物前病原学送检的ICU患者人数。分母：同期使用抗菌药物治疗的ICU患者总人数。', '无', '无', NULL, '无', '无', '无',
    '出院日期', '出院科室名称', '是否同期ICU住院患者使用抗菌药物治疗', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
SET @kpi_name = '（六）ICU抗菌药物治疗前病原学送检率';
SET @category_code = '3.52.6';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', NULL, @data_source_id, '{"p_date_type":"out"}',
    '以治疗为目的使用抗菌药物前病原学送检的ICU患者人数占同期使用抗菌药物治疗的ICU患者总人数的比例', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU患者抗菌药物使用的规范性',
    '重症医学专病表查询', NULL, 'full', '以治疗为目的使用抗菌药物指用药目的为“治疗”的全身给药。病原学检验需在药物治疗前开具医嘱并完成标本采集。', NULL, NULL, NULL, '百分比（%）', '无', '无',
