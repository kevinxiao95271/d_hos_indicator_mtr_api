...
-- 创建分子指标（3.9.1.8.1）
SET @numerator_kpi_name = '行癫痫手术后在院并发症发生人数';
SET @numerator_category_code = '3.9.1.8.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行癫痫手术后在院并发症发生人数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '癫痫手术的术后并发症包括：脑脊液漏、脑积水，颅内/颅外感染（浅表或深部）、颅内或硬膜外脓肿、缺血性脑血管病、颅内血肿、静脉窦血栓形成、深静脉血栓形成、肺栓塞、肺部感染、代谢紊乱、语言障碍、记忆障碍、偏瘫、精神障碍、视野缺损。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否行癫痫手术后在院并发症发生', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.1.8.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.1.8）
SET @kpi_name = '癫痫患者术后并发症发生率';
SET @category_code = '3.9.1.8';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，所有住院行癫痫手术的癫痫患者术后并发症发生率。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.抗癫痫药物规范服用率', '治疗癫痫的主要目标是减少发作频率。准确记录各种发作类型的发作频率是抗癫痫治疗的依据和基础，也与健康相关生活质量的改善密切相关，是反映癫痫治疗效果的重要过程指标之一。',
    '癫痫专病表查询', NULL, '癫痫手术的术后并发症包括：脑脊液漏、脑积水，颅内/颅外感染（浅表或深部）、颅内或硬膜外脓肿、缺血性脑血管病、颅内血肿、静脉窦血栓形成、深静脉血栓形成、肺栓塞、肺部感染、代谢紊乱、语言障碍、记忆障碍、偏瘫、精神障碍、视野缺损。', '百分比（%）', '无', NULL,
