-- ===========================================
-- 0352 专病表指标注册脚本
-- 指标编码：3.52.12（十二）ICU非计划气管插管拔管率
-- 数据源：重症医学专病表查询（分子需扩展非计划拔管字段）
-- ===========================================
...
SET @numerator_kpi_name = 'ICU患者非计划气管插管拔管例数';
SET @numerator_category_code = '3.52.12.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', NULL, @data_source_id, '{"p_date_type":"out"}',
    'ICU患者非计划气管插管拔管例数', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU的管理水平',
    '重症医学专病表查询', NULL, 'full', '分子：ICU患者非计划气管插管拔管例数。分母：同期ICU患者气管插管拔管总例数。', '无', '无', NULL, '无', '无', '无',
...
SET @denominator_kpi_name = '同期ICU患者气管插管拔管总例数';
SET @denominator_category_code = '3.52.12.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', NULL, @data_source_id, '{"p_date_type":"out"}',
    '同期ICU患者气管插管拔管总例数', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU的管理水平',
    '重症医学专病表查询', NULL, 'full', '分子：ICU患者非计划气管插管拔管例数。分母：同期ICU患者气管插管拔管总例数。', '无', '无', NULL, '无', '无', '无',
...
SET @kpi_name = '（十二）ICU非计划气管插管拔管率';
SET @category_code = '3.52.12';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'decrease', 'ratio', NULL, @data_source_id, '{"p_date_type":"out"}',
    'ICU患者非计划气管插管拔管例数占同期ICU患者气管插管拔管总例数的比例', '《重症医学专业医疗质量控制指标（2024年版）》。', '反映ICU的管理水平',
    '重症医学专病表查询', NULL, 'full', '非计划气管插管拔管指非计划拔管。', NULL, NULL, '百分比（%）', '无', '无', '无',
