...
SET @numerator_kpi_name = '行精确近距离放疗技术的宫颈癌患者数';
SET @numerator_category_code = '3.19.4.9.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '行精确近距离放疗技术的宫颈癌患者数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '宫颈癌专病表查询', NULL, '分子：行精确近距离放疗技术的宫颈癌患者数。分母：同期接受近距离放疗的宫颈癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否行精确近距离放疗技术的宫颈癌', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期接受近距离放疗的宫颈癌患者总数';
SET @denominator_category_code = '3.19.4.9.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期接受近距离放疗的宫颈癌患者总数', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '宫颈癌专病表查询', NULL, '分子：行精确近距离放疗技术的宫颈癌患者数。分母：同期接受近距离放疗的宫颈癌患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期接受近距离放疗的宫颈癌患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
SET @kpi_name = '宫颈癌患者精确近距离放疗率';
SET @category_code = '3.19.4.9';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '宫颈癌患者精确近距离放疗率的定义和计算方法', '《肿瘤专业医疗质量控制指标（2023版）》。', '评价肿瘤专业诊疗规范性。',
    '宫颈癌专病表查询', NULL, '分子：行精确近距离放疗技术的宫颈癌患者数。分母：同期接受近距离放疗的宫颈癌患者总数。', '百分比（%）', '无', NULL,
