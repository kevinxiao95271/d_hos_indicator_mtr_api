...
-- 创建分子指标（3.9.2.1.1）
SET @numerator_kpi_name = '使用国际运动障碍疾病协会标准（2015年版）或中国帕金森病的诊断标准（2016年版）进行诊断的住院帕金森病患者数';
SET @numerator_category_code = '3.9.2.1.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '使用国际运动障碍疾病协会标准（2015年版）或中国帕金森病的诊断标准（2016年版）进行诊断的住院帕金森病患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '帕金森病的最终诊断依靠病理诊断或尸检诊断。此处的诊断标准为临床诊断标准，参见国际运动障碍疾病协会（MDS）诊断标准（2015年版）或中国帕金森病的诊断标准（2016版）。临床诊断标准会定期更新。 按出院时间计算。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否使用国际运动障碍疾病协会标准（2015年版）或中国帕金森病的诊断标准（2016年版）进行诊断的帕金森病', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.2.1.2';
CALL sp_kpi_item_create(
...
-- 创建比率指标（3.9.2.1）
SET @kpi_name = '住院帕金森病患者规范诊断率';
SET @category_code = '3.9.2.1';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，使用国际运动障碍疾病协会标准（2015年版）或中国帕金森病的诊断标准（2016年版）进行诊断的住院帕金森病患者数占同期住院帕金森病患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》。 2.住院帕金森病患者完成头颅MRI 或 CT 检查率', '反映医疗机构对于帕金森病规范性诊断的执行情况。有助于提高帕金森病诊疗质量。为制定适宜的治疗方案提供客观依据。',
    '帕金森病专病表查询', NULL, '帕金森病的最终诊断依靠病理诊断或尸检诊断。此处的诊断标准为临床诊断标准，参见国际运动障碍疾病协会（MDS）诊断标准（2015年版）或中国帕金森病的诊断标准（2016版）。临床诊断标准会定期更新。 按出院时间计算。', '百分比（%）', '无', NULL,
