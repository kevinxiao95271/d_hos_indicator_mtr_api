...
-- 创建分子指标（3.9.3.13.1）
SET @numerator_kpi_name = '进食、水前进行吞咽功能筛查的住院脑梗死患者数';
SET @numerator_category_code = '3.9.3.13.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '进食、水前进行吞咽功能筛查的住院脑梗死患者数', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '吞咽功能筛查工具包括洼田饮水试验、洼田吞咽功能障碍评价、Gugging吞咽功能评估表（GUSS）、视频X线透视吞咽检查（VFSS）、显微内镜吞咽功能检查（FEES）。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否进食、水前进行吞咽功能筛查的脑梗死', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.9.3.13.2';
CALL sp_kpi_item_create(
...
SET @category_code = '3.9.3.13';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '单位时间内，进食、水前进行吞咽功能筛查的住院脑梗死患者数，占同期住院治疗的脑梗死患者总数的比例。', '《神经系统疾病医疗质量控制指标（2020 年版）》《中国脑血管病临床管理指南（2019 年版）》。 2.发病 24 小时内脑梗死患者急诊就诊 30 分钟内完成头颅CT 影像学检查率', '反映医疗机构收住院脑梗死患者病情评估开展情况。',
    '脑梗死专病表查询', NULL, '吞咽功能筛查工具包括洼田饮水试验、洼田吞咽功能障碍评价、Gugging吞咽功能评估表（GUSS）、视频X线透视吞咽检查（VFSS）、显微内镜吞咽功能检查（FEES）。', '百分比（%）', '无', NULL,
