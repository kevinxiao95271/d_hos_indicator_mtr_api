...
SET @numerator_kpi_name = '完成随访的IgA肾病患者数';
SET @numerator_category_code = '3.10.1.5.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '完成随访的IgA肾病患者数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者随访的规范性',
    'IgA肾病专病表查询', NULL, '分子：完成随访的IgA肾病患者数。分母：同期IgA肾病患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否完成随访', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_kpi_name = '同期IgA肾病患者总数';
SET @denominator_category_code = '3.10.1.5.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同期IgA肾病患者总数', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者随访的规范性',
    'IgA肾病专病表查询', NULL, '分子：完成随访的IgA肾病患者数。分母：同期IgA肾病患者总数。', '无', '无', NULL,
...
SET @kpi_name = 'IgA肾病患者随访完成率';
SET @category_code = '3.10.1.5';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    'IgA肾病患者完成随访的患者比例', '《肾病专业医疗质量控制指标（2021年版）》。', '评价IgA肾病患者随访的规范性',
    'IgA肾病专病表查询', NULL, '分子：完成随访的IgA肾病患者数。分母：同期IgA肾病患者总数。', '百分比（%）', '无', NULL,
