...
-- 创建分子指标（3.14.4.2.1）
SET @numerator_kpi_name = '住院期间接受心血管风险评估的高血压患者数';
SET @numerator_category_code = '3.14.4.2.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '住院期间接受心血管风险评估的高血压患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对高血压患者规范评估情况',
    '高血压专病表查询', NULL, '分子：住院期间接受心血管风险评估的高血压患者数。心血管风险评估是指完成了心脏、肾脏、血管、眼底四项检查中的两项及以上。分母：同期高血压住院患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否住院期间接受心血管风险评估', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
-- 创建分母指标（3.14.4.2.2）
SET @denominator_kpi_name = '同期高血压住院患者总数';
SET @denominator_category_code = '3.14.4.2.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '高血压住院患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对高血压患者规范评估情况',
    '高血压专病表查询', NULL, '分子：住院期间接受心血管风险评估的高血压患者数。心血管风险评估是指完成了心脏、肾脏、血管、眼底四项检查中的两项及以上。分母：同期高血压住院患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否同期高血压住院患者', NULL, NULL, NULL, NULL, 1.0000, 'sum',
    '["出院科室名称","入院科室名称"]', '[]', '["患者ID","住院号","患者姓名","病案号","出院时间"]',
...
-- 创建比率指标（3.14.4.2）
SET @kpi_name = '心血管风险评估率';
SET @category_code = '3.14.4.2';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '住院期间接受心血管风险评估的高血压患者数，占同期高血压住院患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对高血压患者规范评估情况',
    '高血压专病表查询', NULL, '分子：住院期间接受心血管风险评估的高血压患者数。心血管风险评估是指完成了心脏、肾脏、血管、眼底四项检查中的两项及以上。分母：同期高血压住院患者总数。', '百分比（%）', '无', NULL,
