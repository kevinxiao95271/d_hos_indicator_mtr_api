-- ===========================================
-- 专病表接口指标注册脚本
-- 指标编码：3.14.1.4（与CSV文件中的编码完全一致）
-- 指标名称：发病24小时内急性STEMI患者再灌注治疗率
-- 创建日期：2026-02-04
-- ===========================================
...
-- 创建分子指标（3.14.1.4.1）
SET @numerator_kpi_name = '发病24小时内接受再灌注治疗的急性STEMI患者数';
SET @numerator_category_code = '3.14.1.4.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内接受再灌注治疗的急性STEMI患者数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的规范性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内接受再灌注治疗的急性STEMI患者数。再灌注治疗方式包括：经皮冠状动脉介入治疗（PCI）或静脉溶栓。分母：同期发病24小时内急性STEMI患者总数。', '无', '无', NULL,
    '出院日期', '出院科室名称', '是否发病24小时内接受再灌注治疗', NULL, NULL, NULL, NULL, 1.0000, 'sum',
...
SET @denominator_category_code = '3.14.1.4.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'increase', 'value', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内急性STEMI患者总数', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的规范性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内接受再灌注治疗的急性STEMI患者数。再灌注治疗方式包括：经皮冠状动脉介入治疗（PCI）或静脉溶栓。分母：同期发病24小时内急性STEMI患者总数。', '无', '无', NULL,
...
-- 创建比率指标（3.14.1.4）
SET @kpi_name = '发病24小时内急性STEMI患者再灌注治疗率';
SET @category_code = '3.14.1.4';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'percent', 2, 'increase', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    '发病24小时内接受再灌注治疗的急性STEMI患者数，占同期发病24小时内急性STEMI患者总数的比例', '《心血管系统疾病相关专业医疗质量控制指标（2021年版）》。', '评价医院对急性STEMI患者救治的规范性',
    '急性ST段抬高型心肌梗死专病表查询', NULL, '分子：发病24小时内接受再灌注治疗的急性STEMI患者数。再灌注治疗方式包括：经皮冠状动脉介入治疗（PCI）或静脉溶栓。分母：同期发病24小时内急性STEMI患者总数。', '百分比（%）', '无', NULL,
