...
SET @numerator_kpi_name = 'ICU呼吸机相关性肺炎（VAP）发生例数';
SET @numerator_category_code = '3.1.13.1';
CALL sp_kpi_item_create(
    @numerator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    'ICU呼吸机相关性肺炎（VAP）发生例数', '《重症医学专业医疗质量控制指标（2021年版）》。', '评价ICU呼吸机相关性肺炎发生情况',
    '重症医学专病表查询', NULL, '分子：ICU呼吸机相关性肺炎（VAP）发生例数。分母：同一统计周期内ICU患者有创机械通气总天数。', '无', '无', NULL,
...
SET @denominator_kpi_name = '同一统计周期内ICU患者有创机械通气总天数';
SET @denominator_category_code = '3.1.13.2';
CALL sp_kpi_item_create(
    @denominator_kpi_name, @category_id, NULL, 'integer', 0, 'decrease', 'value', @data_source_id, '{"p_date_type":"out"}',
    '同一统计周期内ICU患者有创机械通气总天数', '《重症医学专业医疗质量控制指标（2021年版）》。', '评价ICU呼吸机相关性肺炎发生情况',
    '重症医学专病表查询', NULL, '分子：ICU呼吸机相关性肺炎（VAP）发生例数。分母：同一统计周期内ICU患者有创机械通气总天数。', '无', '无', NULL,
...
SET @kpi_name = 'ICU呼吸机相关性肺炎（VAP）发病率';
SET @category_code = '3.1.13';
CALL sp_kpi_item_create(
    @kpi_name, @category_id, NULL, 'decimal', 2, 'decrease', 'ratio', @data_source_id, '{"p_date_type":"out"}',
    'VAP发生例数占同期ICU患者有创机械通气总天数的比例', '《重症医学专业医疗质量控制指标（2021年版）》。', '评价ICU呼吸机相关性肺炎发生情况',
    '重症医学专病表查询', NULL, '分子：ICU呼吸机相关性肺炎（VAP）发生例数。分母：同一统计周期内ICU患者有创机械通气总天数。', '例/千机械通气日', '无', NULL,
