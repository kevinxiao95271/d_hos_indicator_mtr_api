 ...
 * 测试所有计算类指标（包含除法表达式的）
 */
public class TestAllCalculatedIndicators {
    ...
    private static final String API_BASE_URL = "http://localhost:8080/dgear/api/indicator-result/calculate";
    ...
    public static void main(String[] args) {
        try {
            ...
            while (rs.next()) {
                ...
                indicator.put("expression", rs.getString("expression"));
                indicators.add(indicator);
            }

            System.out.println("========================================");
            System.out.println("找到 " + indicators.size() + " 个计算类指标");
            System.out.println("========================================\n");
            ...
            for (Map<String, String> indicator : indicators) {
                ...
                String expr = indicator.get("expression");

                System.out.println("测试: " + name + " (" + code + ")");
